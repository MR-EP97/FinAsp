            ...
            <form wire:submit='update'>
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input wire:model.blur="user.email" type="number" class="form-control border border-2 p-2">
                        @error('user.email')
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <select wire:model.blur="user.phone" class="form-select border border-2 p-2">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input wire:model.blur="user.location" type="date" class="form-control border border-2 p-2">
                        @error('user.location')
                        <p class='text-danger inputerror'>{{ $message }} </p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input wire:model.blur="user.location" type="number" class="form-control border border-2 p-2">
                        @error('user.location')
                        <p class='text-danger inputerror'>{{ $message }} </p>
                        @enderror
                    </div>
